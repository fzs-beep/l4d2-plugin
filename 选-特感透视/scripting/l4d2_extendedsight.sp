...
public OnPluginStart()
{
	...
	PluginCvarMode = CreateConVar("l4d2_extendedsight_mode", "3", "在什么情况下启用透视功能？ 1 - 坦克死亡后启用, 2 - 女巫死亡后启用, 3 - 坦克和女巫死亡后启用, 4 - 全程启用, 0 - 关闭", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 4.0);
	PluginCvarNotify = CreateConVar("l4d2_extendedsight_notify", "2", "提示玩家启用了透视功能? 0 - 关闭, 1 - 屏幕中下提示, 2 - 聊天框提示", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 2.0);
	PluginCvarDuration = CreateConVar("l4d2_extendedsight_duration", "60", "透视时长（单位秒）", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 10.0);
	PluginCvarGlow = CreateConVar("l4d2_extendedsight_glowcolor", "255 75 75", "透视颜色，使用RBG颜色，具体颜色百度自定义", FCVAR_PLUGIN|FCVAR_NOTIFY);
	PluginCvarGlowMode = CreateConVar("l4d2_extendedsight_glowmode", "1", "透视模式. 0 - 持续透视, 1 - 每隔一段时间透视一次", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 0.0, true, 1.0);
	PluginCvarGlowFadeInterval = CreateConVar("l4d2_extendedsight_glowfadeinterval", "3", "如启用每隔一段时间透视功能，设置间隔时间（单位秒）", FCVAR_PLUGIN|FCVAR_NOTIFY, true, 1.5, true, 10.0);
	PluginCvarModesOn =	CreateConVar("l4d2_extendedsight_modes_on", "", "插件在以下模式中启用,留空=全部模式启用", FCVAR_PLUGIN|FCVAR_NOTIFY);
	PluginCvarModesOff = CreateConVar("l4d2_extendedsight_modes_off", "versus,teamversus,scavenge,teamscavenge,mutation12,teamrealismversus,mutation11,mutation13,mutation15,mutation18,mutation19,community3,community6,l4d1vs", "插件会在以下模式下被禁用，留空 = 无", FCVAR_PLUGIN|FCVAR_NOTIFY);
