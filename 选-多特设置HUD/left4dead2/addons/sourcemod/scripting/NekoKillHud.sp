...
public void OnPluginStart()
{
	...
	NCvar[CKillHud_AllKill]			 = AutoExecConfig_CreateConVar("KillHud_AllKill", "0", "[0=关|1=开]禁用/启用其他统计显示", _, true, 0.0, true, 1.0);
	NCvar[CKillHud_Show]			 = AutoExecConfig_CreateConVar("KillHud_Show", "0", "[0=开局|1=出安全区]后显示HUD", _, true, 0.0, true, 1.0);
	...
	NCvar[CKillHud_HudStyle]		 = AutoExecConfig_CreateConVar("KillHud_HudStyle", "0", "Hud风格[0=关|1=样式1|2=样式2|3=自定义样式|4=聊天栏输出]", _, true, 0.0, true, 4.0);
	...
	NCvar[CKillHud_StyleChatDelay]	 = AutoExecConfig_CreateConVar("KillHud_StyleChatDelay", "60", "样式4聊天框循环输出延迟", _, true, 10.0, true, 120.0);
