...
public void OnPluginStart()
{
	...
	NCvar[CSpecial_PluginStatus]					  = AutoExecConfig_CreateConVar("Special_PluginStatus", "0", "[0=关|1=开]禁用/启用刷特[禁用后插件将不会刷出特感，若Special_CanCloseDirector为打开状态，将会一只特感都不会刷出]", _, true, 0.0, true, 1.0);
	...
	NCvar[CSpecial_Spawn_Time]						  = AutoExecConfig_CreateConVar("Special_Spawn_Time", "30", "全局特感刷新时间间隔[0-180]", _, true, 0.0, true, 180.0);
	...
	NCvar[CSpecial_Spawn_Time_Easy]					  = AutoExecConfig_CreateConVar("Special_Spawn_Time_Easy", "45", "简单难度特感刷新时间间隔[0-180]", _, true, 0.0, true, 180.0);
	NCvar[CSpecial_Spawn_Time_Normal]				  = AutoExecConfig_CreateConVar("Special_Spawn_Time_Normal", "40", "普通难度特感刷新时间间隔[0-180]", _, true, 0.0, true, 180.0);
	NCvar[CSpecial_Spawn_Time_Hard]					  = AutoExecConfig_CreateConVar("Special_Spawn_Time_Hard", "35", "高级难度特感刷新时间间隔[0-180]", _, true, 0.0, true, 180.0);
	NCvar[CSpecial_Spawn_Time_Impossible]			  = AutoExecConfig_CreateConVar("Special_Spawn_Time_Impossible", "30", "专家难度特感刷新时间间隔[0-180]", _, true, 0.0, true, 180.0);

	NCvar[CSpecial_Num]								  = AutoExecConfig_CreateConVar("Special_Num", "6", "特感初始的刷新数量[1-32]", _, true, 1.0, true, 32.0);
	...
	NCvar[CSpecial_Spawn_Tank_Alive]				  = AutoExecConfig_CreateConVar("Special_Spawn_Tank_Alive", "0", "[0=关|1=开]特感是否在坦克活着时刷新", _, true, 0.0, true, 1.0);
	...
	NCvar[CSpecial_Boomer_Spawn_MaxDis]				  = AutoExecConfig_CreateConVar("Special_Boomer_Spawn_MaxDis", "1500", "Boomer刷新最大距离[范围不能小于1|仅梦魇、炼狱、可变模式有效]", _, true, 1.0, false);
	NCvar[CSpecial_Smoker_Spawn_MaxDis]				  = AutoExecConfig_CreateConVar("Special_Smoker_Spawn_MaxDis", "1500", "Smoker刷新最大距离[范围不能小于1|仅梦魇、炼狱、可变模式有效]", _, true, 1.0, false);
	NCvar[CSpecial_Charger_Spawn_MaxDis]			  = AutoExecConfig_CreateConVar("Special_Charger_Spawn_MaxDis", "1500", "Charger刷新最大距离[范围不能小于1|仅梦魇、炼狱、可变模式有效]", _, true, 1.0, false);
	NCvar[CSpecial_Hunter_Spawn_MaxDis]				  = AutoExecConfig_CreateConVar("Special_Hunter_Spawn_MaxDis", "1500", "Hunter刷新最大距离[范围不能小于1|仅梦魇、炼狱、可变模式有效]", _, true, 1.0, false);
	NCvar[CSpecial_Spitter_Spawn_MaxDis]			  = AutoExecConfig_CreateConVar("Special_Spitter_Spawn_MaxDis", "1500", "Spitter刷新最大距离[范围不能小于1|仅梦魇、炼狱、可变模式有效]", _, true, 1.0, false);
	NCvar[CSpecial_Jockey_Spawn_MaxDis]				  = AutoExecConfig_CreateConVar("Special_Jockey_Spawn_MaxDis", "1500", "Jockey刷新最大距离[范围不能小于1|仅梦魇、炼狱、可变模式有效]", _, true, 1.0, false);
	...
	NCvar[CSpecial_Spawn_MinDis]					  = AutoExecConfig_CreateConVar("Special_Spawn_MinDis", "1000", "全部特感刷新最小距离[范围不能小于1|仅导演和普通模式有效]", _, true, 1.0, false);
	...
	NCvar[CSpecial_Attack_PlayerNotInCombat_Time]	  = AutoExecConfig_CreateConVar("Special_Attack_PlayerNotInCombat_Time", "5", "检查玩家是否一直处于摸鱼状态，达到指定秒数，将让其中一只特感目标设置为该玩家，Special_Attack_PlayerNotInCombat启用后才生效[3-15秒]", _, true, 3.0, true, 15.0);
