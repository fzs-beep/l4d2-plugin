...
public OnPluginStart()
{
	...
	CreateConVar("damage_display_version", PLUGIN_VERSION, "version", FCVAR_PLUGIN|FCVAR_NOTIFY|FCVAR_SPONLY|FCVAR_DONTRECORD);
...
stock DisplayDamage(const dmg, const DeadType:type, const attacker)
{
	...
	Format(DamageDisplayString[attacker][0], DamageDisplayLength, "造成 %d HP %s", dmg, DamagePrintBuffer[type]);
