...
public void OnPluginStart()
{
	...
	g_hClientTimeOut = CreateConVar("l4d2_dlock_timeout", "50", "在地图启动后，插件将等待多少秒，然后才放弃等待客户端", CVAR_FLAGS);
	g_hBreakTheDoor = CreateConVar("l4d2_dlock_weakdoor", "0", "一旦打开，安全室的门就会被打破", CVAR_FLAGS);
	g_hDisplayPanel = CreateConVar("l4d2_dlock_displaypanel", "2", "显示玩家状态面板。0-禁用，1-隐藏失败，2-完整信息", CVAR_FLAGS);
