...
{
	cvM60AmmoSet = CreateConVar("l4d2_M60_nodrop_ammopile_patch", "600", "设置机枪M60后备弹药数量.", FCVAR_NOTIFY);
	cvM60AmmoSet.AddChangeHook(CVChanged);
...
public void CVChanged(ConVar convar, const char[] oldValue, const char[] newValue)
{
	InitM60Ammo();
}
...
void InitM60Ammo()
{
	g_iM60AmmoSet = cvM60AmmoSet.IntValue;
}
...
{
	SetConVarInt(FindConVar("ammo_m60_max"), g_iM60AmmoSet, false, false);
}
