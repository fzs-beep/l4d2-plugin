			...
			if (IsClientInGame(i) && IsValidPlayer(i))
			{
				if (IsFakeClient(i) && GetClientTeam(i) == 2)
				{
					switch (GetRandomInt(1, 13))
					{
						case 1:
						{
							Format(botchat,sizeof(botchat),"%N，这个生还者就是逊啦！",client);
						}
						case 2:
						{
						...
						case 4:
						{
							Format(botchat,sizeof(botchat),"哪个哈皮又倒地了？");
						}
						case 5:
						{
							Format(botchat,sizeof(botchat),"%N，你再倒地我们电脑人就开始跑分了",client);
						}
						case 6:
						{
						...
						case 7:
						{
							Format(botchat,sizeof(botchat),"地上凉，快起来");
						}
						case 8:
						{
						...
						case 11:
						{
							Format(botchat,sizeof(botchat),"小老弟，咋躺地上睡了捏");
						}
						case 12:
						{
		...
		for (new i = 1; i <= MaxClients; i++)
		{
			...
			if (IsFakeClient(i) && GetClientTeam(i) == 2)
			{
				switch (GetRandomInt(1, 18))
				{
					...
					case 2:
					{
						Format(botchat,sizeof(botchat),"你是饿了吗，这么急着接饼吃？");
					}
					case 3:
					{
	...
	if (IsFakeClient(attacker) && IsValidPlayer(victim) && !IsFakeClient(victim))
			{
			    switch (GetRandomInt(1, 16))
				{
					...
					case 2:
					{
						CPrintToChatAll("{red}Tank{default} :  看我全垒打！");
					}
					case 3:
					{
					...
					case 5:
					{
						CPrintToChatAll("{red}Tank{default} :  不是我扔得准，是你接得准");
					}
					case 6:
					{
					...
					case 7:
					{
						CPrintToChatAll("{red}Tank{default} :  咕咕嘎嘎！");
					}
					case 8:
					{
						CPrintToChatAll("{red}Tank{default} :  黑人抬走，有请下一位");
					}
					case 9:
					{
					...
					case 16:
					{
						CPrintToChatAll("{red}Tank{default} :  我这20年的石头，你接得住吗");
					}
				}
			}
}
		...
		for (new i = 1; i <= MaxClients; i++)
		{
			...
			if (IsFakeClient(i) && GetClientTeam(i) == 2)
			{
				switch (GetRandomInt(1, 7))
				{
					case 1:
					{
						Format(botchat,sizeof(botchat),"你打个锤子警报呢");
					}
					case 2:
					{
						Format(botchat,sizeof(botchat),"靠腰了，咋把警报打了");
					}
					case 3:
					{
					...
					case 4:
					{
						Format(botchat,sizeof(botchat),"你真是个神人，能打警报");
					}
					case 5:
					{
						Format(botchat,sizeof(botchat),"狗！你个狗");
					}
					case 6:
					{
	...
	if (IsValidPlayer(attacker) && IsValidPlayer(victim) && !IsFakeClient(attacker))
	{
			...
			if (IsFakeClient(victim) && GetClientTeam(victim) == 2)
			{
				switch (GetRandomInt(1, 7))
				{
					case 1:
					{
						Format(botchat,sizeof(botchat),"队伍里有内鬼！");
					}
					case 2:
					{
						Format(botchat,sizeof(botchat),"我宣布，年度最佳持枪特感就是你");
					}
					case 3:
					{
						Format(botchat,sizeof(botchat),"拜托，眼睛没用可以捐了");
					}
					case 4:
					{
						Format(botchat,sizeof(botchat),"别再让你的子弹亲吻我的屁股！");
					}
					case 5:
					{
					...
					case 6:
					{
						Format(botchat,sizeof(botchat),"你的子弹划过完美的曲线，击中了友军");
					}
					case 7:
					{
	...
	if (IsValidPlayer(attacker) && IsValidPlayer(victim) && !IsFakeClient(attacker))
	{
			...
			if (IsFakeClient(victim) && GetClientTeam(victim) == 2)
			{
				switch (GetRandomInt(1, 12))
				{
					case 1:
					{
						Format(botchat,sizeof(botchat),"谢谢你哦，给电脑打包真奢侈");
					}
					case 2:
					{
					...
					case 6:
					{
						Format(botchat,sizeof(botchat),"我惊了，这包过期了吧");
					}
					case 7:
					{
	...
	if (IsValidPlayer(attacker) && IsValidPlayer(victim) && !IsFakeClient(attacker))
	{
			...
			if (IsFakeClient(victim) && GetClientTeam(victim) == 2)
			{
				switch (GetRandomInt(1, 9))
				{
					...
					case 5:
					{
						Format(botchat,sizeof(botchat),"这一套电疗就很奈斯~");
					}
					case 6:
					{
					...
					case 8:
					{
						Format(botchat,sizeof(botchat),"头一回感觉自己竟然辣么重要！");
					}
					case 9:
					{
						Format(botchat,sizeof(botchat),"把我电起来继续吃子弹吗？");
					}
				}
				CPrintToChatAll("{blue}%N{default} :  %s", victim, botchat);
			}
		...
		for (new i = 1; i <= MaxClients; i++)
		{
			...
			if (IsFakeClient(i) && GetClientTeam(i) == 2 && height > 400)
			{
				switch (GetRandomInt(1, 9))
				{
					case 1:
					{
						Format(botchat,sizeof(botchat),"快看，天上有飞碟");
					}
					case 2:
					{
					...
					case 3:
					{
						Format(botchat,sizeof(botchat),"%N您可关心关心四周吧",victim);
					}
					case 4:
					{
					...
					case 5:
					{
						Format(botchat,sizeof(botchat),"别打扰，让他们亲热亲热");
					}
					case 6:
					{
		...
		if (IsClientInGame(i) && IsValidPlayer(i))
		{
			if (IsFakeClient(i) && GetClientTeam(i) == 2)
			{
				switch (GetRandomInt(1, 6))
				{
					...
					case 5:
					{
						Format(botchat,sizeof(botchat),"弱智特感滚吧");
					}
					case 6:
					{
		...
		{
            {
			    switch (GetRandomInt(1, 22))
				{
					case 1:
					{
						CPrintToChatAll("{red}Witch{default} :  小哥哥，还懂得怜香惜玉哟");
					}
					case 2:
					{
						CPrintToChatAll("{red}Witch{default} :  来来来，朝头这打");
					}
					case 3:
					{
					...
					case 4:
					{
						CPrintToChatAll("{red}Witch{default} :  小老弟，给你机会不中用啊");
					}
					case 5:
					{
					...
					case 6:
					{
						CPrintToChatAll("{red}Witch{default} :  小哥哥，我好怕怕!");
					}
					case 7:
					{
						CPrintToChatAll("{red}Witch{default} :  不讲武德，搞偷袭是吧");
					}
					case 8:
					{
						CPrintToChatAll("{red}Witch{default} :  我可不是什么娇滴滴的女巫");
					}
					case 9:
					{
						CPrintToChatAll("{red}Witch{default} :  来，让老娘给你松松骨");
					}
					case 10:
					{
					...
					case 13:
					{
						CPrintToChatAll("{red}Witch{default} :  你劈我瓜是吧！");
					}
					case 14:
					{
						CPrintToChatAll("{red}Witch{default} :  这就是惹我的下场");
					}
					case 15:
					{
					...
					case 22:
					{
						CPrintToChatAll("{red}Witch{default} :  大哥，这并不好笑");
					}
				}
			}
        }
