...
public OnPluginStart()
{
	...
	selfstandup_health_incap1	= CreateConVar("selfstandup_health_incap1",	"40.0",		"倒地消耗 止疼药 自救后有多少临时血量");
	selfstandup_health_incap2	= CreateConVar("selfstandup_health_incap2",	"25.0",		"倒地消耗 肾上腺素 自救后有多少临时血量");
	selfstandup_health_incap3	= CreateConVar("selfstandup_health_incap3",	"60.0",		"倒地消耗 医疗包 自救后有多少临时血量");
	selfstandup_health_incap4	= CreateConVar("selfstandup_health_incap4",	"35.0",		"倒地消耗 电击器 自救后有多少临时血量");
	selfstandup_health_incap5	= CreateConVar("selfstandup_health_incap5",	"20.0",		"倒地消耗 高爆弹药盒 自救后有多少临时血量");
	selfstandup_health_incap6	= CreateConVar("selfstandup_health_incap6",	"20.0",		"倒地消耗 燃烧弹药盒 自救后有多少临时血量");
	
	selfstandup_duration			= CreateConVar("selfstandup_duration",			"10.0",		"自救所需时间(限制：0 ~ 15秒之间 )");
	...
	selfstandup_crawl					= CreateConVar("selfstandup_crawl",					"1",			"玩家是否可在倒地时爬行？0=关闭 1=开启");
	...
	selfstandup_color					= CreateConVar("selfstandup_color",					"1",			"是否设置玩家黑白的颜色？0=关闭 1=开启");
	selfstandup_Glow					= CreateConVar("selfstandup_Glow",					"1",			"是否设置玩家黑白的光环？0=关闭 1=开启");
