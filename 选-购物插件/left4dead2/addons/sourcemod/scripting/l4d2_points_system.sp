...
void InitSettings() {
	...
	g_eGeneral.cSettings[SettingAllow]				= CreateConVar("l4d2_points_allow", "1", "0=插件关闭，1=插件打开.");
	g_eGeneral.cSettings[SettingModes]				= CreateConVar("l4d2_points_modes", "", "在这些游戏模式下打开插件,用逗号分隔（没有空格）.（空=全部）.");
	g_eGeneral.cSettings[SettingModesOff]			= CreateConVar("l4d2_points_modes_off", "", "在这些游戏模式下关闭插件,用逗号分隔（没有空格）.（空=无）.");
	g_eGeneral.cSettings[SettingModesTog]			= CreateConVar("l4d2_points_modes_tog", "0", "在这些游戏模式下打开插件. 0=All, 1=Coop, 2=Survival, 4=Versus, 8=Scavenge. Add numbers together.");
	g_eGeneral.cSettings[SettingStartPoints]		= CreateConVar("l4d2_points_start", "10", "玩家初始积分", _, true, 0.0);
	g_eGeneral.cSettings[SettingMaxPoints]			= CreateConVar("l4d2_points_max", "999999", "玩家玩家所能拥有的最大积分, 达到该值后积分将不再增加(该值必须设置为大于上面的初始积分值才会生效)", _, true, 0.0);
...
void InitItemCosts() {
	...
	g_eGeneral.cItemCosts[CostUZI]				= CreateConVar("l4d2_points_smg", "15", "购买乌兹冲锋枪需要多少积分");
	g_eGeneral.cItemCosts[CostSilenced]			= CreateConVar("l4d2_points_silenced", "17", "购买消音冲锋枪需要多少积分");
	g_eGeneral.cItemCosts[CostMP5]				= CreateConVar("l4d2_points_mp5", "15", "购买MP5冲锋枪需要多少积分");
	g_eGeneral.cItemCosts[CostM16]				= CreateConVar("l4d2_points_m16", "25", "购买M16突击步枪需要多少积分");
	g_eGeneral.cItemCosts[CostAK47]				= CreateConVar("l4d2_points_ak47", "35", "购买AK47突击步枪需要多少积分");
	g_eGeneral.cItemCosts[CostSCAR]				= CreateConVar("l4d2_points_scar", "30", "购买SCAR-H突击步枪需要多少积分");
	g_eGeneral.cItemCosts[CostSG552]			= CreateConVar("l4d2_points_sg552", "25", "购买SG552突击步枪需要多少积分");
	g_eGeneral.cItemCosts[CostMilitary]			= CreateConVar("l4d2_points_military", "50", "购买30发连发狙击枪需要多少积分");
	g_eGeneral.cItemCosts[CostAWP]				= CreateConVar("l4d2_points_awp", "100", "购买awp狙击枪需要多少积分");
	g_eGeneral.cItemCosts[CostScout]			= CreateConVar("l4d2_points_scout", "35", "购买侦察狙击步枪(鸟狙)需要多少积分");
	g_eGeneral.cItemCosts[CostHunting]			= CreateConVar("l4d2_points_hunting", "40", "购买狩猎狙击步枪(猎枪)需要多少积分");
	g_eGeneral.cItemCosts[CostPump]				= CreateConVar("l4d2_points_pump", "15", "购买一代木喷需要多少积分");
	g_eGeneral.cItemCosts[CostChrome]			= CreateConVar("l4d2_points_chrome", "17", "购买二代铁喷需要多少积分");
	g_eGeneral.cItemCosts[CostAuto]				= CreateConVar("l4d2_points_auto", "20", "购买一代连喷需要多少积分");
	g_eGeneral.cItemCosts[CostSPAS]				= CreateConVar("l4d2_points_spas", "22", "购买二代连喷需要多少积分");
	g_eGeneral.cItemCosts[CostGrenade]			= CreateConVar("l4d2_points_grenade", "100", "购买榴弹发射器需要多少积分");
	g_eGeneral.cItemCosts[CostM60]				= CreateConVar("l4d2_points_m60", "100", "购买M60机枪需要多少积分");
	g_eGeneral.cItemCosts[CostGasCan]			= CreateConVar("l4d2_points_gascan", "50", "购买汽油桶需要多少积分");
	...
	g_eGeneral.cItemCosts[CostFireaxe]			= CreateConVar("l4d2_points_fireaxe", "10", "购买消防斧需要多少积分");
	g_eGeneral.cItemCosts[CostFryingpan]		= CreateConVar("l4d2_points_fryingpan", "10", "购买平底锅需要多少积分");
	g_eGeneral.cItemCosts[CostMachete]			= CreateConVar("l4d2_points_machete", "10", "购买小砍刀需要多少积分");
	g_eGeneral.cItemCosts[CostBaseballbat]		= CreateConVar("l4d2_points_baseballbat", "10", "购买棒球棒需要多少积分");
	g_eGeneral.cItemCosts[CostCrowbar]			= CreateConVar("l4d2_points_crowbar", "10", "购买撬棍需要多少积分");
	...
	g_eGeneral.cItemCosts[CostKatana]			= CreateConVar("l4d2_points_katana", "10", "购买武士刀需要多少积分");
	g_eGeneral.cItemCosts[CostElectricguitar]	= CreateConVar("l4d2_points_electricguitar", "10", "购买电吉他需要多少积分");
	g_eGeneral.cItemCosts[CostKnife]			= CreateConVar("l4d2_points_knife", "10", "购买小刀需要多少积分");
	...
	g_eGeneral.cItemCosts[CostPipe]				= CreateConVar("l4d2_points_pipe", "15", "购买土制炸弹需要多少积分");
	g_eGeneral.cItemCosts[CostMolotov]			= CreateConVar("l4d2_points_molotov", "50", "购买燃烧瓶需要多少积分");
	g_eGeneral.cItemCosts[CostBile]				= CreateConVar("l4d2_points_bile", "15", "购买胆汁需要多少积分");
	g_eGeneral.cItemCosts[CostHealthKit]		= CreateConVar("l4d2_points_medkit", "50", "购买医疗包需要多少积分");
	g_eGeneral.cItemCosts[CostDefib]			= CreateConVar("l4d2_points_defib", "50", "购买电击器需要多少积分");
	g_eGeneral.cItemCosts[CostAdren]			= CreateConVar("l4d2_points_adrenaline", "20", "购买肾上腺素需要多少积分");
	g_eGeneral.cItemCosts[CostPills]			= CreateConVar("l4d2_points_pills", "25", "购买止痛药需要多少积分");
	...
	g_eGeneral.cItemCosts[CostHeal]				= CreateConVar("l4d2_points_survivor_heal", "70", "购买回满血量需要多少积分");
	g_eGeneral.cItemCosts[CostAmmo]				= CreateConVar("l4d2_points_refill", "5", "购买弹药补充需要多少积分");
...
void InitPointRewards() {
	...
	g_eGeneral.cPointRewards[RewardSHeadShots]	= CreateConVar("l4d2_points_headshots_value", "6", "爆头击杀一定数量的感染者可以获得多少积分");
	g_eGeneral.cPointRewards[RewardSKillI]		= CreateConVar("l4d2_points_sikill", "1", "击杀一个特感可以获得多少积分");
	g_eGeneral.cPointRewards[RewardSKillTank]	= CreateConVar("l4d2_points_tankkill", "20", "击杀一只坦克可以获得多少积分");
	g_eGeneral.cPointRewards[RewardSKillWitch]	= CreateConVar("l4d2_points_witchkill", "5", "击杀一个女巫可以获得多少积分");
	g_eGeneral.cPointRewards[RewardSCrownWitch] = CreateConVar("l4d2_points_witchcrown", "5", "秒杀一个女巫可以获得多少积分");
	g_eGeneral.cPointRewards[RewardSTeamHeal]	= CreateConVar("l4d2_points_heal", "5", "治疗一个队友可以得到多少积分");
	...
	g_eGeneral.cPointRewards[RewardSTeamDefib]	= CreateConVar("l4d2_points_defib_action", "5", "电击器复活一个队友可以获得多少积分");
	g_eGeneral.cPointRewards[RewardSSoloTank]	= CreateConVar("l4d2_points_tanksolo", "50", "单独击杀一只坦克可以获得多少积分");
...
void InitSpecialCosts() {
	...
	g_eSpecial.cLeechHealth[1]					= CreateConVar("l4d2_points_special_leech1", "50", "购买2生命汲取需要多少积分");
	g_eSpecial.cLeechHealth[2]					= CreateConVar("l4d2_points_special_leech2", "100", "购买3生命汲取需要多少积分");
	g_eSpecial.cLeechHealth[3]					= CreateConVar("l4d2_points_special_leech3", "150", "购买4生命汲取需要多少积分");
	g_eSpecial.cLeechHealth[4]					= CreateConVar("l4d2_points_special_leech4", "200", "购买5生命汲取需要多少积分");
	g_eSpecial.cRealodSpeedUp[0]				= CreateConVar("l4d2_points_special_reload0", "50", "购买1.5x加速装填需要多少积分");
	g_eSpecial.cRealodSpeedUp[1]				= CreateConVar("l4d2_points_special_reload1", "100", "购买2.0x加速装填需要多少积分");
	g_eSpecial.cRealodSpeedUp[2]				= CreateConVar("l4d2_points_special_reload2", "150", "购买2.5x加速装填需要多少积分");
	g_eSpecial.cRealodSpeedUp[3]				= CreateConVar("l4d2_points_special_reload3", "200", "购买3.0x加速装填需要多少积分");
	g_eSpecial.cRealodSpeedUp[4]				= CreateConVar("l4d2_points_special_reload4", "300", "购买3.5x加速装填需要多少积分");
}
...
void RegisterCommands() {
	...
	RegAdminCmd("sm_scjf",	cmdDelOld,	ADMFLAG_ROOT, "sm_delold <天数> 删除超过多少天未上线的玩家记录");
	RegAdminCmd("sm_lcjf", cmdListPoints, ADMFLAG_ROOT, "列出每个玩家的积分数量.");
	RegAdminCmd("sm_szjf", cmdSetPoints, ADMFLAG_ROOT, "sm_setpoints <目标> [数量]设置玩家XXX拥有XXX数量的积分");
	RegAdminCmd("sm_gjf", cmdGivePoints, ADMFLAG_ROOT, "sm_givepoints <目标> [数量]给玩家XXX发XXX数量的积分");
	RegAdminCmd("sm_jzjf", cmdListModules, ADMFLAG_GENERIC, "列出当前加载到积分系统的模块");
