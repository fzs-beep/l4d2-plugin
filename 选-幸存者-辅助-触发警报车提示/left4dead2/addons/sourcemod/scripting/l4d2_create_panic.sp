...
public void CheckAlarm(int zero) // Zero is basically a null variable, I didn't need to pass a variable but I'm forced to.
{
	if(!AlarmWentOff)
		return;
	...
	PrintToChatAll("\x04[提示]\x03%s\x05触发了汽车警报\x04.", clientName);//聊天窗提示.
}
