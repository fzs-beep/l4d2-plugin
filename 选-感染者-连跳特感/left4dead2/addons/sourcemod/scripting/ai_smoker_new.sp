...
public void OnPluginStart()
{
	...
	g_hSmokerBhopSpeed = CreateConVar("ai_SmokerBhopSpeed", "80", "Smoker连跳的速度", FCVAR_NOTIFY, true, 0.0);
	...
	g_hLeftDistance = CreateConVar("ai_SmokerLeftBehindDistance", "15", "玩家距离团队多远判定为落后或超前", FCVAR_NOTIFY, true, 0.0);
	g_hDistancePercent = CreateConVar("ai_SmokerDistantPercent", "0.9", "舌头如果处在这个系数 * 舌头长度的距离范围内，则会立刻拉人", FCVAR_NOTIFY, true, 0.0);
	g_hTongueRange = FindConVar("tongue_range");
	
	AutoExecConfig(true, "ai_smoker_new");
